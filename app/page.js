...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24 sm:text-clip sm:font-serif">
      <div className="z-10 w-full max-w-5xl items-center justify-between p-10 font-mono text-sm lg:flex">
